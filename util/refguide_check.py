...
Check for a pyEDFlib submodule whether the objects in its __all__ dict
...
in docstrings. This is differenpt from doctesting [we do not aim to have
...
def check_rest(module, names, dots=True):
    ...
    for name in names:
        ...
        if m:
            msg = (
                f"Docstring contains a non-printable character {m.group(1)!r}! "
                'Maybe forgot r"""?'
            )
