# -*- coding: utf-8 -*-
#
# PyYAWT documentation build configuration file, created by
...
project = 'PyEDFlib'
# copyright = jinja2.filters.do_mark_safe('2006-%s, <a href="https://groups.google.com/forum/#!forum/pyyawt">The PyYAWT Developers</a>' % datetime.date.today().year)
...
modindex_common_prefix = ['pyedflib.']
...
html_title = 'PyEDFlib Documentation'
...
latex_documents = [
  ('index', 'PyEDFlib.tex', 'PyEDFlib Documentation',
   'The PyEDFlib Developers', 'manual'),
]
