...
def set_patientcode(handle: int, patientcode: str) -> int: ...
def write_annotation_latin1(handle: int, onset: int, duration: int, description: str) -> int: ...
def write_annotation_utf8(handle: int, onset: int, duration: int, description: str) -> int: ...
def set_technician(handle: int, technician: str) -> int: ...
...
def set_recording_additional(handle: int, recording_additional: str) -> int: ...
...
def set_patientname(handle: int, name: str) -> int: ...
...
def set_patient_additional(handle: int, patient_additional: str) -> int: ...
...
def set_equipment(handle: int, equipment: str) -> int: ...
def set_samples_per_record(handle: int, edfsignal: int, smp_per_record: int) -> int: ...
def set_admincode(handle: int, admincode: str) -> int: ...
def set_label(handle: int, edfsignal: int, label: str) -> int: ...
def tell(handle: int, edfsignal: int) -> int: ...
def rewind(handle: int, edfsignal: int) -> None: ...
def set_sex(handle: int, sex: int) -> int: ...
def set_gender(handle: int, gender: int) -> int: ...
def set_physical_dimension(handle: int, edfsignal: int, phys_dim: str) -> int: ...
def set_transducer(handle: int, edfsignal: int, transducer: str) -> int: ...
def set_prefilter(handle: int, edfsignal: int, prefilter: str) -> int: ...
...
def set_datarecord_duration(handle: int, duration: int) -> int: ...
