...
class CyEdfReader:
    def __init__(
        self, file_name: str, annotations_mode: int = ..., check_file_size: int = ...
    ): ...
    ...
    def readsignal(
        self, signalnum: int, start: int, n: int, sigbuf: np.ndarray[np.float64_t]
    ) -> None: ...
...
def write_annotation_latin1(
    handle: int, onset: int, duration: int, description: str | bytes
) -> int: ...
def write_annotation_utf8(
    handle: int, onset: int, duration: int, description: str | bytes
) -> int: ...
...
def read_int_samples(
    handle: int, edfsignal: int, n: int, buf: np.ndarray[np.int32_t]
) -> int: ...
def blockwrite_digital_samples(handle: int, buf: np.ndarray[np.int32_t]) -> int: ...
def blockwrite_digital_short_samples(
    handle: int, buf: np.ndarray[np.int16_t]
) -> int: ...
...
def read_physical_samples(
    handle: int, edfsignal: int, n: int, buf: np.ndarray[np.float64_t]
) -> int: ...
...
def set_birthdate(
    handle: int, birthdate_year: int, birthdate_month: int, birthdate_day: int
) -> int: ...
...
def set_physical_dimension(
    handle: int, edfsignal: int, phys_dim: str | bytes
) -> int: ...
